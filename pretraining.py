...
from common import (Pdn_small3, get_pdn_medium,
...
def get_argparse():
    ...
    parser.add_argument('-o', '--output_folder', default='output/pretraining/res1/')
    return parser.parse_args()

# variables
model_size = 'small'
imagenet_train_path = 'E:/mht/imagenet_100k_512px/content/train'
seed = 42
...
def main():
    ...
    print(summary(backbone, (3, 512, 512), device='cpu'))
    ...
    if model_size == 'small':
        pdn = Pdn_small3(out_channels)
    elif model_size == 'medium':
        pdn = get_pdn_medium(out_channels)
    else:
        raise Exception()
